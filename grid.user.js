  ...
  function TranslationFactory() {
    const translations = {
      ...
      de: {
        ...
        duplicateWarning: 'Mehrere "Grid View"-Erweiterungen gefunden. Bitte deinstallieren Sie Duplikate.',
        hideParticipant: 'Teilnehmer verbergen',
        showParticipant: 'Teilnehmer anzeigen',
        advancedSettingsLink: 'Erweiterte Einstellungen anzeigen',
        advancedSettingsTitle: 'Erweiterte Einstellungen von Google Meet Grid View',
        bottomToolbarBehavior: 'Verhalten der unteren Funktionsleiste',
        btbNative: 'Raster verdecken wenn Funktionsleiste sichtbar',
        btbResize: 'Grösse des Rasters ändern wenn Funktionsleiste sichtbar',
        btbForce: 'Funktionsleiste immer anzeigen und Grösse des Rasters ändern',
        rightToolbarBehavior: 'Verhalten von Chat & Teilnehmerliste',
        rtbNative: 'Raster verdecken wenn Chat sichtbar',
        rtbResize: 'Grösse des Rasters ändern wenn Chat sichtbar',
        ownVideoBehavior: 'Eigenes Video im Raster',
        ovbNative: 'Behalte Video gespiegelt',
        ovbFlip: 'Zeige Video wie es andere Teilnehmer sehen',
        presentationBehavior: 'Eigene Präsentation im Raster',
        pbNever: 'Zeige meine Präsentation nie im Raster',
        pbOwnVideo: 'Zeige meine Präsentation im Raster wenn "Mich im Raster anzeigen" ausgewählt',
        pbAlways: 'Zeige meine Präsentation immer im Raster',
        modifyNames: 'Teilnehmernamen ändern',
