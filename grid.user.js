  ...
  function TranslationFactory() {
    const translations = {
      ...
      uk: {
        ...
        autoEnable: 'Увімкнути режим сітки за замовчуванням',
        notRunning: 'На цій сторінці не працює режим сітки',
        noMeeting: 'Режим сітки не можливо запустити, поки ви не приєднаєтесь до наради',
        enabled: 'Режим сітки увімкнено',
        sourceCode: 'Вихідний код доступний на GitHub',
        screenCaptureMode: 'Увімкнено режим зйомки екрана',
        screenCaptureModeDescription: 'Примусово 16: 9, імена не відображаються, відео заблоковні на місці',
        unauthorizedWarning: 'ПОПЕРЕДЖЕННЯ: Це неавторизоване розширення. Будь ласка, встановіть офіційний реліз, натиснувши тут.',
        duplicateWarning: 'Виявлено кілька розширень Grid View. Видаліть дублікати.',
        hideParticipant: 'Сховати учасника',
        showParticipant: 'Показати учасника',
        advancedSettingsLink: 'Переглянути додаткові налаштування',
        advancedSettingsTitle: 'Додаткові налаштування',
        bottomToolbarBehavior: 'Поведінка нижньої панелі інструментів',
        btbNative: 'Приховати сітку, коли відображається панель інструментів',
        btbResize: 'Змінити розмір сітки, коли відображається панель інструментів',
        btbForce: 'Завжди показувати панель інструментів та змінювати розмір сітки',
        rightToolbarBehavior: 'Поведінка чату та учасників',
        rtbNative: 'Приховати сітку, коли відображається чат',
        rtbResize: 'Змінити розмір сітки, коли відображається чат',
        ownVideoBehavior: 'Поведінка власного відео у сітці',
        ovbNative: 'Віддзеркалювати відео',
        ovbFlip: 'Віддзеркалювати відео, щоб воно відповідало тому, що бачать інші',
        presentationBehavior: 'Поведінка власної презентації',
        pbNever: 'Ніколи не показувати презентацію в сітці',
        pbOwnVideo: 'Показувати презентацію в сітці, коли вибрано "Включити себе в сітку"',
        pbAlways: 'Завжди показувати презентацію в сітці',
        modifyNames: 'Змінити імена учасників',
        mnNative: 'Без змін ("Альфа Браво Чарлі")',
        mnFirstSpace: 'Перемістити перше слово в кінець ("Браво Чарлі, Альфа")',
        mnLastSpace: 'Перемістіть останнє слово до початку ("Чарлі, Альфа Браво")',
        forceQuality: 'Якість відео',
        fqAuto: 'Автоматично на основі розміру відео та кількості учасників',
        fqGood: 'Добра',
        fqMediocre: 'Звичайна',
        fqBad: 'Погана',
        fqWorst: 'Найгірша',
