...
;(function () {
  ...
  function TranslationFactory() {
    const translations = {
      ...
      'pt-PT': {
        showOnlyVideo: 'Mostrar só participantes com vídeo',
        highlightSpeaker: 'Destacar quem está a falar',
        includeOwnVideo: 'Incluir o meu vídeo na grelha',
        autoEnable: 'Activar visualização em grelha por defeito',
        ...
        enabled: 'Activar visualização em grelha',
        sourceCode: 'Código fonte disponível no Github',
        screenCaptureMode: 'Activar captura de ecrã',
        screenCaptureModeDescription: 'Forçar aspecto 16:9, Remover nomes, Parar posição dos vídeos',
